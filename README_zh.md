...
> 项目正在从早期 demo CLI 演进为具有推理、记忆与多 Runtime 接入能力的 Agent 系统。总体目标见 [`ROADMAP.md`](ROADMAP.md)，当前进度见 [`pm-state.md`](pm-state.md)，历史变化见 [`CHANGELOG.md`](CHANGELOG.md)，接手规范见 [`AGENTS.md`](AGENTS.md)。下面内容主要描述现有早期 CLI。
