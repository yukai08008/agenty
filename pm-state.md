...
- **feature/runtime-machine-opencode** (DEVELOPING)
  - 当前切片：Runtime 状态模型、公共协议和 OpenCode `probe`
...
- 从 OpenCode 的真实能力出发实现 Runtime Machine 第一切片，再返回顶层校准 AgentyMachine。
...
- [ ] 定义 Runtime 状态、事件、能力和错误模型
- [ ] 实现 OpenCode 无副作用探测
- [ ] 回到 AgentyMachine 校准顶层所需事件
